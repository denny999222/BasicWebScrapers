...
(async () => {
  ...
  for (let movie of URLS) {
    ...
    // downloading a lot of images, say 1000 images will not work, but something like 5 images will
    // this is because we are opening multiple streams without letting them finish
    let stream = request({
      uri: img1,
      headers: {
        'accept': "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
